...
--
-- Dumping data for table `watchlist_assets`
--

LOCK TABLES `watchlist_assets` WRITE;
/*!40000 ALTER TABLE `watchlist_assets` DISABLE KEYS */;
/*!40000 ALTER TABLE `watchlist_assets` ENABLE KEYS */;
UNLOCK TABLES;
